...
try {
    ...
    awk -f ci/amalgamate.awk $src/fiftyone.h $src/ip-graph-cxx/graph.h >dd/ip-intelligence-cxx.h
    awk -f ci/amalgamate.awk $src/common-cxx/*.c $src/ip-graph-cxx/*.c $src/*.c >dd/ip-intelligence-cxx.c
} finally {
